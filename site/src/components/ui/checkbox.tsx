 ...
 * without these the mixed state drew a tick on an unfilled box — which reads
 * as "on" at a glance and "off" on closer inspection. It gets the filled
 * treatment and a dash instead, so all three states are distinguishable.
 */
function Checkbox({
  className,
  ...props
