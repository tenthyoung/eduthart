...
/**
 * Dashboard chrome shared by the artist workspace and the account area: a
 * full-height sidebar (collapsible on desktop, a drawer on mobile) plus a
 * header row and content region. Rendered instead of the marketing navbar.
 */
      ...
      <div className="flex min-h-screen">
        ...
        >
          ...
          <div className={cn("px-4 py-5", isSidebarCollapsed && "lg:hidden")}>
            ...
            <WorkspaceSidebarNav items={navItems} pathname={pathname} />
          </div>
